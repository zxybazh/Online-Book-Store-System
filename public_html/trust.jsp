...
<div class="container">
    <fieldset>
        <div id="legend">
            <legend class="">Trust or Untrust someone</legend>
        </div>
    </fieldset>
    ...
    <div class="tabbable"> <!-- Only required for left/right tabs -->
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="tab1" style="padding-top: 10px">
                <form action="trust_handler.jsp" method="post" onsubmit="return forward1()">
                    <div class="control-group">
                        <label class="control-label" for="username">Username</label>

                        <div class="form-inline">
                            <input type="text" id="username" name="tr_username" placeholder=""
                                   class="form-control" value="">
                        </div>
                    </div>

                    <div class="control-group" style="padding-top: 22px">
                        <label class="control-label" for="trway1">Select the way you change authority</label>

                        <div class="form-inline">
                            <select class="form-control" id="trway1" name="trway">
            ...
            <div class="tab-pane" id="tab2" style="padding-top: 10px">
                <form action="trust_handler.jsp" method="post" onsubmit="return forward2()">
                    <div class="control-group">
                        <label class="control-label" for="userid">User ID</label>

                        <div class="form-inline">
                            <input type="number" id="userid" name="tr_userid" placeholder=""
                                   class="form-control" value="">
                        </div>
                    </div>

                    <div class="control-group" style="padding-top: 22px">
                        <label class="control-label" for="trway2">Select the way you change authority</label>

                        <div class="form-inline">
                            <select class="form-control" id="trway2" name="trway">
                                <option value="trust">Trust</option>
                                <option value="untrust">Untrust</option>
                            </select>
                        </div>
    ...
    <script>
        function forward1() {
            ...
            if (un.length < 3 || un.length > 30) {
                ...
                alert("Username contain illegal characters >_<");
            } else if (un == "<%=username%>") {
                alert("You can't trust or untrust yourself");
            } else return true;
            return false;
        }
        function forward2() {

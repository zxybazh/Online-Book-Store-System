...
<div class="container">
    <fieldset>
        <div id="legend">
            <legend class="">Give User Awards</legend>
        </div>
    </fieldset>
    ...
    <div class="tabbable"> <!-- Only required for left/right tabs -->
        <ul class="nav nav-tabs">
            <li <%=ss1%>><a href="#tab1" data-toggle="tab">Most trusted users</a></li>
            <li <%=ss2%>><a href="#tab2" data-toggle="tab">Most helpful users</a></li>
        </ul>
        <div class="tab-content">
            <div class="tab-pane<%=ts1%>" id="tab1" style="padding-top: 10px">
                <form action="user_award.jsp" method="post" onsubmit="return forward()">
                ...
                <%
                    Vector<Vector<String>> a = myapi.UserAwardsForTrust(m1);
                    if (a != null && a.size() > 0) {
                %>
            ...
            <div class="tab-pane<%=ts2%>" id="tab2" style="padding-top: 10px">
                ...
                <%
                    a = myapi.UserAwardsForHelpfulness(m2);
                    if (a != null && a.size() > 0) {
                %>
                <table class="table table-striped">
                    <thead>
